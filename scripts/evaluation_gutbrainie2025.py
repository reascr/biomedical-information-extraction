...
RESULTS_DIR_NER = os.path.join(script_dir,"..", "results", "NER", "BERT-models")
# using challenge script to calculate metrics (cf. https://github.com/MMartinelli-hub/GutBrainIE_2025_Baseline/blob/main/Eval/evaluate.py)


# DEFINE HERE THE PATH(S) TO YOUR PREDICTIONS
PREDICTIONS_PATH_6_1 = os.path.join(RESULTS_DIR_NER,"predictions/predictions_PubMedBERT_42")
...
GROUND_TRUTH_PATH = os.path.join(DATA_DIR,"Annotations/Dev/json_format/dev.json")
